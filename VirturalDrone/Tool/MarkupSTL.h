...
public:
	...
	bool AddElem(const char* szName, int nData)
	{
		std::ostringstream oss;
		oss << nData;
		return AddElem(szName, oss.str().c_str());
	}
	...
	bool AddChildElem(const char* szName, int nData)
	{
		std::ostringstream oss;
		oss << nData;
		return AddChildElem(szName, oss.str().c_str());		
	}
